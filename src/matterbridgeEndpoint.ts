...
export class MatterbridgeEndpoint extends Endpoint {
   ...
   * @returns {this} The current MatterbridgeEndpoint instance for chaining.
   */
  createDefaultHeatingThermostatClusterServer(localTemperature: number = 23, occupiedHeatingSetpoint: number = 21, minHeatSetpointLimit: number = 0, maxHeatSetpointLimit: number = 50, outdoorTemperature: number = 12): this {
