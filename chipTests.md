...
| `Test_TC_EEVSE_2_1.yaml`       | Corrects the unsupported constraint type spellings `energy-mWh` and `epoch-s` to the YAML runner's registered `energy_mwh` and `epoch_s` types. The upstream spellings make the runner reject every otherwise valid value before evaluating the DUT response.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| `TC_EEVSE_2_2.py`              | Targets the configured EVSE endpoint (1401 or 14011) for the `UserMaximumChargeCurrent` write instead of the upstream test's hardcoded endpoint `1`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
