...
| ---------------------- | ------ | -------- | ------------------------------------------- |
| AudioDoorbell          | 0x0141 | 2        | Initial release; Remove superset            |
...
| Doorbell               | 0x0148 | 2        | Initial release; Remove superset            |
...
| Thermostat (2)                                        | 0x0201 | 9     | 10    | Removed Zigbee related elements and P quality, deprecated ThermostatProgrammingOperationMode and removed ProgrammingOperationModeBitmap and deprecated Setback feature and related elements. |
...
| Chime                               | 0x0556 | 2        | Initial; Add ChimeStartedPlaying event, new optional param to PlayChimeSound to play a specific sound, and remove F quality from InstalledChimeSounds release  |
