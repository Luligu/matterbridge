...
export function MatterbridgeLogo(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg xmlns='http://www.w3.org/2000/svg' xmlnsXlink='http://www.w3.org/1999/xlink' viewBox='0 0 296.2 296.2' {...props}>
      <defs>
        <linearGradient id='lg1' x1='16.6' y1='16.6' x2='279.6' y2='279.6' gradientUnits='userSpaceOnUse'>
          <stop offset='0' stopColor='#00b48d' />
          <stop offset='.1' stopColor='#3faa77' />
          <stop offset='.3' stopColor='#234148' />
          <stop offset='.7' stopColor='#203b44' />
          <stop offset='.9' stopColor='#ad2e6e' />
          <stop offset='1' stopColor='#c81b74' />
        </linearGradient>
        <linearGradient id='lg2' x1='31.1' y1='31.1' x2='265.1' y2='265.1' gradientUnits='userSpaceOnUse'>
          <stop offset='0' stopColor='#00b48d' />
          <stop offset='.2' stopColor='#285251' />
          <stop offset='.4' stopColor='#234148' />
          <stop offset='.8' stopColor='#203b44' />
          <stop offset='.9' stopColor='#a8316c' />
          <stop offset='1' stopColor='#c81b74' />
        </linearGradient>
        <linearGradient id='lg3' x1='116.2' y1='143.9' x2='139.8' y2='143.9' gradientUnits='userSpaceOnUse'>
          <stop offset='0' stopColor='#8bc751' />
          <stop offset='1' stopColor='#0db14b' />
        </linearGradient>
        <linearGradient id='lg4' x1='136.1' y1='100.8' x2='159.6' y2='100.8' xlinkHref='#lg3' />
        <linearGradient id='lg5' x1='155.3' y1='143.9' x2='178.9' y2='143.9' xlinkHref='#lg3' />
        <linearGradient id='lg6' x1='46.8' y1='25.7' x2='89.6' y2='74.8' gradientUnits='userSpaceOnUse'>
          <stop offset='0' stopColor='#b1d34a' />
          <stop offset='1' stopColor='#50b848' />
        </linearGradient>
      </defs>
