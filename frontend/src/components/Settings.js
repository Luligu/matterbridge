...
function MatterbridgeSettings({ matterbridgeInfo, systemInfo }) {
  ...
  const handleSaveChangePassword = (password) => {
    ...
    sendMessage({ method: "/api/config", src: "Frontend", dst: "Matterbridge", params: { name: 'setpassword', value: password } });
  };
  ...
  const handleChangeBridgeMode = (event) => {
    ...
    sendMessage({ method: "/api/config", src: "Frontend", dst: "Matterbridge", params: { name: 'setbridgemode', value: event.target.value } });
  };
  ...
  const handleChangeMbLoggerLevel = (event) => {
    ...
    sendMessage({ method: "/api/config", src: "Frontend", dst: "Matterbridge", params: { name: 'setmbloglevel', value: event.target.value } });
  };
  ...
  const handleLogOnFileMbChange = (event) => {
    ...
    sendMessage({ method: "/api/config", src: "Frontend", dst: "Matterbridge", params: { name: 'setmblogfile', value: event.target.checked } });
  };
...
function MatterSettings({ matterbridgeInfo }) {
  ...
  const handleChangeMjLoggerLevel = (event) => {
    ...
    sendMessage({ method: "/api/config", src: "Frontend", dst: "Matterbridge", params: { name: 'setmjloglevel', value: event.target.value } });
  };
  ...
  const handleLogOnFileMjChange = (event) => {
    ...
    sendMessage({ method: "/api/config", src: "Frontend", dst: "Matterbridge", params: { name: 'setmjlogfile', value: event.target.checked } });
  };
  ...
  const handleChangeMdnsInterface = (event) => {
    ...
    sendMessage({ method: "/api/config", src: "Frontend", dst: "Matterbridge", params: { name: 'setmdnsinterface', value: event.target.value } });
  };
  ...
  const handleChangeIpv4Address = (event) => {
    ...
    sendMessage({ method: "/api/config", src: "Frontend", dst: "Matterbridge", params: { name: 'setipv4address', value: event.target.value } });
  };
  ...
  const handleChangeIpv6Address = (event) => {
    ...
    sendMessage({ method: "/api/config", src: "Frontend", dst: "Matterbridge", params: { name: 'setipv6address', value: event.target.value } });
  };
  ...
  const handleChangeMatterPort = (event) => {
    ...
    sendMessage({ method: "/api/config", src: "Frontend", dst: "Matterbridge", params: { name: 'setmatterport', value: event.target.value } });
  };
  ...
  const handleChangeMatterDiscriminator = (event) => {
    ...
    sendMessage({ method: "/api/config", src: "Frontend", dst: "Matterbridge", params: { name: 'setmatterdiscriminator', value: event.target.value } });
  };
  ...
  const handleChangemMatterPasscode = (event) => {
    ...
    sendMessage({ method: "/api/config", src: "Frontend", dst: "Matterbridge", params: { name: 'setmatterpasscode', value: event.target.value } });
  };
