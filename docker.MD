...
### Run the Docker container and start it with full access to the host network (this is working)
```
docker run --name matterbridge --network host --restart always -d luligu/matterbridge
```
