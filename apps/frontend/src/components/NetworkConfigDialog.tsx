      ...
      <DialogContent dividers>
        ...
        {networkType === 'static' && (
          <Grid container spacing={2} sx={{ mt: 2 }}>
            <Grid size={6}>
              <TextField label='IP Address' fullWidth value={staticConfig.ip} onChange={handleFieldChange('ip')} />
            </Grid>
            <Grid size={6}>
              <TextField label='Subnet Mask' fullWidth value={staticConfig.subnet} onChange={handleFieldChange('subnet')} />
            </Grid>
            <Grid size={6}>
              <TextField label='Gateway' fullWidth value={staticConfig.gateway} onChange={handleFieldChange('gateway')} />
            </Grid>
            <Grid size={6}>
              <TextField label='DNS Server' fullWidth value={staticConfig.dns} onChange={handleFieldChange('dns')} />
            </Grid>
          </Grid>
        )}
      </DialogContent>
