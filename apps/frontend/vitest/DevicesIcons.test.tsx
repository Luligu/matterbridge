...
describe('DevicesIcons', () => {
  ...
  it('should render all supported device icon values when cluster data is available', async () => {
    ...
    expectText('Front');
    expectText('3300 mV');
    expect(screen.getAllByText('Controller')).toHaveLength(8);
...
function createFullDeviceClusters(): Cluster[] {
  ...
  add(0x002b, 'Fan', [['FanControl', 'percentCurrent', '33', 33]]);
  ...
  add(0x002d, 'AirPurifier', [['FanControl', 'percentCurrent', '45', 45]]);
