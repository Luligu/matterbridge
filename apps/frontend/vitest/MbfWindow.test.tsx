...
import { MbfWindow, MbfWindowHeader, MbfWindowHeaderText, MbfWindowFooter, MbfWindowFooterText, MbfWindowText, MbfWindowIcons } from '../src/components/MbfWindow';
...
describe('MbfWindow components', () => {
  ...
  it('renders MbfWindow with children and merges style', () => {
    const { getByText, container } = render(<MbfWindow style={{ backgroundColor: 'red' }}>Test Window</MbfWindow>);
  ...
  it('renders MbfWindowHeader and merges style', () => {
    const { getByText, container } = render(<MbfWindowHeader style={{ height: '40px' }}>Header</MbfWindowHeader>);
  ...
  it('renders MbfWindowFooter and merges style', () => {
    const { getByText, container } = render(<MbfWindowFooter style={{ height: '40px' }}>Footer</MbfWindowFooter>);
  ...
  it('renders close button and calls onClose when clicked', () => {
    const onClose = vi.fn();
    const { getByRole } = render(<MbfWindowIcons close={onClose} />);
