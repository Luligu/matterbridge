...
applyTo: 'chipTests.json, chipTests.md, chipTests.log, chipTestsSummary.log, scripts/run-matterbridge-chip-tests.mjs, packages/core/src/chipTests.ts, packages/core/src/demoDevices.ts, packages/core/src/helpers.ts, docker/Dockerfile.chip-test, docker/entrypoint.chip-test.sh, docker/chip-test/**, .github/workflows/docker-buildx-chip-test.yml, .github/workflows/chip-tests.yml'
---
