...
const jestConfig = {
  ...
  testPathIgnorePatterns: ['/node_modules/', '/dist/', '/vitest/', '/frontend/', '/src/crypto/', '/src/dgram/', '/src/mock/'], // Ignore specific paths for test files
  coveragePathIgnorePatterns: ['/node_modules/', '/dist/', '/vitest/', '/frontend/', '/src/crypto/', '/src/dgram/', '/src/mock/'], // Ignore specific paths for test and coverage
