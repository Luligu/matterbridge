...
const jestConfig = {
  ...
  testPathIgnorePatterns: ['/node_modules/', '/dist/', '/vitest/', '/frontend/', '/src/crypto/', '/src/workers/', '/src/mock/', 'matterNode', 'jestHelpers.ts'], // Ignore specific paths for test files
  coveragePathIgnorePatterns: ['/node_modules/', '/dist/', '/vitest/', '/frontend/', '/src/crypto/', '/src/workers/', '/src/mock/', 'matterNode', 'jestHelpers.ts'], // Ignore specific paths for test and coverage
