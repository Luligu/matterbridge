...
- The skills it lists under [.agents/skills](./.agents/skills/) are also available as slash commands in [.claude/commands](.claude/commands/): `/verify-agent-context`, `/matterjs-pr-workflow`, `/verify-npm-alignment`, `/verify-server-endpoint-context`, `/verify-version-alignment`.
