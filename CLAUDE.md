...
- The skills it lists under [.agents/skills](./.agents/skills/) are also available as agent skills in [.claude/skills](.claude/skills/), invocable as slash commands and discovered automatically.
