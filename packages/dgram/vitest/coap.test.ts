/**
 * @file packages/dgram/vitest/coap.test.ts
...
describe('Coap', () => {
  let coap: Coap;
  let mockSocket: Mocked<dgram.Socket>;
  ...
  beforeEach(() => {
    ...
    vi.spyOn(coap.log, 'log').mockImplementation(() => {});
  });
  ...
  describe('onMessage', () => {
    beforeEach(() => {
      ...
      vi.spyOn(coap, 'onCoapMessage').mockImplementation(() => {});
      vi.spyOn(coap, 'logCoapMessage').mockImplementation(() => {});
    });
  ...
  describe('onCoapMessage', () => {
    ...
    it('should handle CoAP message and log debug information', () => {
      ...
      const debugSpy = vi.spyOn(coap.log, 'debug');
    ...
    it('should be extensible for subclasses (like CoIoT)', () => {
      ...
      const onCoapMessageSpy = vi.spyOn(coap, 'onCoapMessage');
