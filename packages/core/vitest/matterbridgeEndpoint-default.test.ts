...
describe('Matterbridge ' + NAME, () => {
  ...
  test('createDefaultSchedulesThermostatClusterServer defaults', async () => {
    ...
    await flushAsync();
    expect(device.getAttribute(Thermostat.id, 'systemMode')).toBe(Thermostat.SystemMode.Auto);
    expect(device.getAttribute(Thermostat.id, 'acceptedCommandList')).toEqual([0, 5, 254]);
    expect(device.getAttribute(Thermostat.id, 'generatedCommandList')).toEqual([253]);
  ...
  test('createDefaultSchedulesThermostatClusterServer', async () => {
    ...
    expect(device.getAttribute(Thermostat.id, 'acceptedCommandList')).toEqual([0, 5, 254]);
    expect(device.getAttribute(Thermostat.id, 'generatedCommandList')).toEqual([253]);
    expect(device.getAttribute(Thermostat.id, 'numberOfSchedules')).toBe(2);
  ...
  test('createUserPinDoorLockClusterServer with RFID credential support', async () => {
    ...
    device.createDefaultIdentifyClusterServer();
    device.createUserPinDoorLockClusterServer(DoorLock.LockState.Locked, DoorLock.LockType.DeadBolt, 0, 4, 10, undefined, undefined, undefined, undefined, false, 10);
  ...
  test('createUserPinDoorLockClusterServer with custom RFID code length', async () => {
    ...
    device.createDefaultIdentifyClusterServer();
    device.createUserPinDoorLockClusterServer(DoorLock.LockState.Locked, DoorLock.LockType.DeadBolt, 0, 4, 10, undefined, undefined, undefined, undefined, false, 5, 4, 10);
