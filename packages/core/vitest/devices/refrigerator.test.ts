...
describe('Matterbridge ' + NAME, () => {
  ...
  test('device forEachAttribute', () => {
    ...
    expect(
      ...
      [
        ...
        'descriptor(0x1d).deviceTypeList(0x0)=[ { deviceType: 112, revision: 3 }, { deviceType: 17, revision: 1 } ]',
  ...
  test('cabinet1 forEachAttribute', () => {
    ...
    expect(
      ...
      [
        ...
        'descriptor(0x1d).clientList(0x2)=[  ]',
        'descriptor(0x1d).clusterRevision(0xfffd)=3',
        'descriptor(0x1d).deviceTypeList(0x0)=[ { deviceType: 113, revision: 6 } ]',
  ...
  test('createDefaultRefrigeratorAlarmClusterServer normalizes different parameters', () => {
    const requireSpy = vi.spyOn(device.behaviors as any, 'require').mockImplementation(() => {});
