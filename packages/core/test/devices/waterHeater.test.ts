...
import { MatterbridgeWaterHeaterManagementServer, MatterbridgeWaterHeaterModeServer, WaterHeater } from '../../src/devices/waterHeater.js';
...
import { loggerErrorSpy, loggerFatalSpy, loggerLogSpy, loggerWarnSpy, setupTest } from '../../src/jestutils/jestSetupTest.js';
import { waterHeater } from '../../src/matterbridgeDeviceTypes.js';
  ...
  test('device forEachAttribute', async () => {
    ...
    expect(
      ...
      [
        ...
        'thermostat(0x201).featureMap(0xfffc)={ heating: true, cooling: false, occupancy: false, setback: false, autoMode: false, localTemperatureNotExposed: false, matterScheduleConfiguration: false, presets: false }',
