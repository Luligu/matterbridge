...
describe('Matterbridge ' + NAME, () => {
  ...
  test('create the server node', async () => {
    await createServerNode(MATTER_PORT, batteryStorage.code);
  ...
  test('device forEachAttribute', async () => {
    ...
    expect(
      ...
      [
        ...
        'descriptor(0x1d).deviceTypeList(0x0)=[ { deviceType: 24, revision: 2 }, { deviceType: 17, revision: 1 }, { deviceType: 1296, revision: 1 }, { deviceType: 1293, revision: 3 } ]',
        'descriptor(0x1d).featureMap(0xfffc)={ tagList: true }',
        'descriptor(0x1d).generatedCommandList(0xfff8)=[  ]',
        'descriptor(0x1d).partsList(0x3)=[ 3 ]',
        'descriptor(0x1d).serverList(0x1)=[ 3, 29, 47, 64, 144, 145, 152, 156, 159 ]',
        ...
        'deviceEnergyManagement(0x98).esaType(0x0)=5',
        ...
        "fixedLabel(0x40).labelList(0x0)=[ { label: 'composed', value: 'Battery Storage' } ]",
        ...
        'powerSource(0x2f).endpointList(0x1f)=[ 2, 3 ]',
