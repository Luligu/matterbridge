...
// Matterbridge
import { roomAirConditioner } from '../../src/matterbridgeDeviceTypes.js';
  ...
  test('device forEachAttribute', async () => {
    ...
    expect(
      ...
      [
        ...
        'descriptor(0x1d).deviceTypeList(0x0)=[ { deviceType: 114, revision: 3 }, { deviceType: 17, revision: 1 } ]',
        ...
        'fanControl(0x202).clusterRevision(0xfffd)=6',
