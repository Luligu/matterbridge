  ...
  test('device forEachAttribute', async () => {
    ...
    expect(
      ...
      [
        ...
        'descriptor(0x1d).deviceTypeList(0x0)=[ { deviceType: 23, revision: 1 }, { deviceType: 17, revision: 1 }, { deviceType: 1296, revision: 1 }, { deviceType: 1293, revision: 2 } ]',
        ...
        'electricalEnergyMeasurement(0x91).cumulativeEnergyExported(0x2)={ energy: 0, startTimestamp: undefined, endTimestamp: undefined, startSystime: undefined, endSystime: undefined }',
        'electricalEnergyMeasurement(0x91).cumulativeEnergyImported(0x1)={ energy: 0, startTimestamp: undefined, endTimestamp: undefined, startSystime: undefined, endSystime: undefined }',
