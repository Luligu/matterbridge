/**
 * @file packages/core/src/matterbridgeAccessoryPlatform.ts
 * @description This file contains the class MatterbridgeAccessoryPlatform.
 * @author Luca Liguori
 * @created 2023-12-29
 * @version 1.0.6
 * @license Apache-2.0
...
logModuleLoaded('MatterbridgeAccessoryPlatform');
