...
process.argv = ['node', 'matterbridge.js', '--frontend', '0', '--port', MATTER_PORT.toString(), '--homedir', HOMEDIR, '--bridge', '--logger', 'debug', '--matterlogger', 'debug'];
...
import { contactSensor, onOffLight } from './matterbridgeDeviceTypes.js';
import { MatterbridgeEndpoint } from './matterbridgeEndpoint.js';
import { featuresFor } from './matterbridgeEndpointHelpers.js';
import { camelCase, createClusterServer, getServerBehaviorFromClusterId, pascalCase, snakeCase } from './matterbridgeFactory.js';
