...
class TC_AVSUM_2_7(MatterBaseTest, AVSUMTestBase):
    ...
    async def test_TC_AVSUM_2_7(self):
        ...
        await self.send_dptz_set_viewport_command(endpoint, videoStreamID, smallfailingviewport, expected_status=Status.DynamicConstraintError)
        ...
        self.step(9)
        await self.send_dptz_set_viewport_command(endpoint, videoStreamID, largefailingviewport, expected_status=Status.DynamicConstraintError)
        ...
        self.step(14)
        await self.send_dptz_set_viewport_command(endpoint, videoStreamID, failingviewport, expected_status=Status.DynamicConstraintError)
